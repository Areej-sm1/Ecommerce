...
<main>
    ...
    <div class="row">
                ...
                <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                    ...
                    <li>
                        <a href="{{route('products')}}"  class="nav-link align-middle px-0">
                            <i class="fs-4 bi-speedometer2"></i> <span class="ms-1 d-none d-sm-inline text-white">Product</span>
                         </a>
                      
                    </li>
                    <li>
                        <a href="{{route('productdet')}}"  class="nav-link align-middle px-0">
                            <i class="fs-4 bi-speedometer2"></i> <span class="ms-1 d-none d-sm-inline text-white">Product details</span>
                         </a>
        ...
        <div class="col-auto col-sm-10 col-xl-6 px-sm-6 px-0">
            @yield('content')
        </div>
     </div>
